...
<body>
	<div class="card card-info">
		<div class="card-header">
			<h3 class="card-title">
				<i class="fa fa-table"></i> Biodata Ibu
			</h3>
		</div>
		<?php
									...
									?>
										<tr>
											...
											<td>
												...
												<a href="?page=del-ibu&kode=<?php echo $data['id_ibu']; ?>" onclick="return confirm('Apakah anda yakin hapus data ini ?')" title="Hapus" class="btn btn-danger btn-sm">
		...
		<?php
					...
					echo '<p align="center">Biodata Ibu Belum Tersedia <br>Klik Button dibawah ini untuk input Biodata</p>';
					...
					if ($sql_check_biodata->num_rows > 0) {
						...
						echo '<br><p align="center">Data Biodata Ibu Tidak Ditemukan <br></p>';
