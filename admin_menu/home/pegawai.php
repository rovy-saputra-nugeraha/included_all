...
<div class="row">
	<div class="col-lg-3 col-6">
		...
		<div class="small-box bg-primary">
			...
			<a href="?page=data-kepegawaian" class="small-box-footer">Selengkapnya
	...
	<div class="col-lg-3 col-6">
		...
		<div class="small-box bg-success">
			...
			<a href="?page=data-kepegawaian" class="small-box-footer">Pegawai
			</a>
		</div>
	</div>
	<!-- ./col -->
	<div class="col-lg-3 col-6">
		...
		<div class="small-box bg-danger">
			...
			<a href="?page=data-kepegawaian" class="small-box-footer">Honorer
			</a>
		</div>
	</div>
	<!-- ./col -->
