			...
			<div class="row">
				<div class="col-md-8 offset-md-2">
					<div class="card">
						...
						<div class="card-body">
							<form action="./konfig/update_keterangan_keluar_siswa.php" method="POST" enctype="multipart/form-data">
								...
								<div class="form-group pt-3">
									...
									<a href="index.php?page=absensi-keluar-siswa" class="btn btn-outline-danger ml-2">Batal</a>
								</div>
							</form>
						</div>
					</div>
