...
if (isset($_POST['tanggal'])) {
    ...
    $date = $_POST['tanggal'];
    $absent = $date;
    $sql = mysqli_query($dbconnect, "SELECT tb_absen.id, tb_id.nama, tb_id.status_kartu, tb_absen.masuk, tb_absen.keluar, tb_absen.date, tb_absen.status, tb_absen.keterangan, tb_absen.berkas FROM tb_absen INNER JOIN tb_id ON tb_absen.id=tb_id.id WHERE tb_absen.date='$date' AND tb_id.status_kartu='Siswa'");
} else {
    $flag = '0';
    $date = date('Y-m-d');
    $absent = $date;
...
<body>
    <div class="content-header ml-3 mr-3">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">DATA PRESENSI MASUK SISWA</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                                ...
                                <div class="table table-hover">
                                    ...
                                    <table id="example" class="table table-striped table-bordered dt-responsive nowrap" id="dataTables-example" style="width: 100%;">
                                        ...
                                        <tbody>
                                                ...
                                                <tr class="<?php echo $color; ?>">
                                                    ...
                                                    <td>
                                                        <?php if (!empty($data['berkas'])) : ?>
                                                            ...
                                                            <a href="./index.php?page=edit_absen_siswa&id=<?php echo $data['id']; ?>&nama=<?php echo $data['nama']; ?>&tanggal=<?php echo $absent; ?>&status=A&flag=<?php echo $flag; ?>">
                                            ...
                                            <?php
                                            $flag = '1';
                                            // Menampilkan siswa yang tidak ada absen
                                            ...
                                            ?>
                                                ...
                                                <tr class="table-danger">
                                                    ...
                                                    <td>
                                                        <a href="./index.php?page=edit_absen_siswa&id=<?php echo $data1['id']; ?>&nama=<?php echo $data1['nama']; ?>&tanggal=<?php echo $absent; ?>&status=A&flag=<?php echo $flag; ?>">
                                                            <b>ALFA</b>
                                                        </a>
                                                    </td>
                                                    <td>-</td>
