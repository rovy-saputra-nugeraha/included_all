								...
								<tr class="odd gradeX">
									...
									<td>
										<center>
											...
											<a href="./index.php?page=edit_siswa&id=<?php echo $data['id']; ?>&nisn=<?php echo $data['nisn'];?>&tahun_masuk=<?php echo $data['tahun_masuk'];  ?>&nama=<?php echo $data['nama']; ?>&chatid=<?php echo $data['chatid'];?>" class="btn btn-outline-primary btn-sm ml-3" data-toggle="tooltip" title="Edit"><i class="fas fa-edit"></i></a>
										</center>
									</td>
								</tr>
