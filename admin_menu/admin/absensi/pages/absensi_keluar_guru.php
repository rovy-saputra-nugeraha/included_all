...
<body>
    <div class="content-header ml-3 mr-3">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">DATA PRESENSI KELUAR GURU</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                                        ...
                                        <tbody>
                                                ...
                                                <tr class="<?php echo $color; ?>">
                                                    ...
                                                    <td>
                                                        <?php if (!empty($data['berkas'])) : ?>
                                                            ...
                                                            <a href="./index.php?page=edit_absen_keluar_guru&id=<?php echo $data['id']; ?>&nama=<?php echo $data['nama']; ?>&tanggal=<?php echo $absent; ?>&status=A&flag=<?php echo $flag; ?>">
                                            ...
                                            ?>
                                                ...
                                                <tr class="table-danger">
                                                    ...
                                                    <td>
                                                        <a href="./index.php?page=edit_absen_keluar_guru&id=<?php echo $data1['id']; ?>&nama=<?php echo $data1['nama']; ?>&tanggal=<?php echo $absent; ?>&status=A&flag=<?php echo $flag; ?>">
                                                            <b>ALFA</b>
                                                        </a>
                                                    </td>
                                                    <td>-</td>
