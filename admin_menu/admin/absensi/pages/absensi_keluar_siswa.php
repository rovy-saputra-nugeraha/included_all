...
if (isset($_POST['tanggal'])) {
    ...
    $date = $_POST['tanggal'];
    $absent = $date;
    $sql = mysqli_query($dbconnect, "SELECT tb_absen_keluar.id, tb_id.nama, tb_id.status_kartu, tb_absen_keluar.keluar, tb_absen_keluar.date, tb_absen_keluar.status, tb_absen_keluar.keterangan, tb_absen_keluar.berkas FROM tb_absen_keluar INNER JOIN tb_id ON tb_absen_keluar.id=tb_id.id WHERE tb_absen_keluar.date='$date' AND tb_id.status_kartu='Siswa'");
} else {
    $flag = '0';
    $date = date('Y-m-d');
    $absent = $date;
                                ...
                                <div class="table table-hover">
                                    ...
                                    <table id="example" class="table table-striped table-bordered dt-responsive nowrap" id="dataTables-example" style="width: 100%;">
                                        ...
                                        <tbody>
                                                ...
                                                <tr class="<?php echo $color; ?>">
                                                    ...
                                                    <td>
                                                        <?php if (!empty($data['berkas'])) : ?>
                                                            ...
                                                            <a href="./index.php?page=edit_absen_keluar_siswa&id=<?php echo $data['id']; ?>&nama=<?php echo $data['nama']; ?>&tanggal=<?php echo $absent; ?>&status=A&flag=<?php echo $flag; ?>">
                                            ...
                                            $sql1 = mysqli_query($dbconnect, "SELECT * FROM tb_id WHERE id NOT IN (SELECT id FROM tb_absen_keluar WHERE date='$absent') AND status_kartu='Siswa'");
                                            ...
                                            ?>
                                                ...
                                                <tr class="table-danger">
                                                    ...
                                                    <td>
                                                        <a href="./index.php?page=edit_absen_keluar_siswa&id=<?php echo $data1['id']; ?>&nama=<?php echo $data1['nama']; ?>&tanggal=<?php echo $absent; ?>&status=A&flag=<?php echo $flag; ?>">
                                                            <b>ALFA</b>
                                                        </a>
                                                    </td>
                                                    <td>-</td>
