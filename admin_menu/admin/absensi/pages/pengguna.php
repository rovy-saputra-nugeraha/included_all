              ...
              <tr class="odd gradeX">
                ...
                <td>
                  <center>
                    ...
                    <a href="./index.php?page=edit_pengguna&no=<?php echo $data['no']; ?>&username=<?php echo $data['username']; ?>&role=<?php echo $data['level']; ?>" class="btn btn-outline-primary btn-sm ml-3" data-toggle="tooltip" title="Edit"><i class="fas fa-edit"></i></a>
                  </center>
                </td>
              </tr>
