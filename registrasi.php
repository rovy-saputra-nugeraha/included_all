      ...
      <script>
        function updateCountdown() {
          ...
          var intervalId = setInterval(function() {
            ...
            countdownElement.innerHTML = 'Pendaftaran Ulang PPDB SDN 013 TPI Barat Dibuka Pada  <br>' + formatTimeYMD();
        ...
        function formatTimeYMD() {
          var targetDateTime = <?php echo json_encode($targetDateTime); ?>;
          var dateObject = new Date(targetDateTime);
